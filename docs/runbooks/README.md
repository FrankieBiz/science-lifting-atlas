...
Operating procedure for this repository. Start here when you are about to do
work, not after.

| Runbook                                            | Use it when                                                                    |
| -------------------------------------------------- | ------------------------------------------------------------------------------ |
| [`current-work.md`](current-work.md)               | Before editing anything — claim your task, branch, base commit, and paths      |
...
[`docs/product/master-plan.md`](../product/master-plan.md), and its section 18
queue resolves any conflict.
